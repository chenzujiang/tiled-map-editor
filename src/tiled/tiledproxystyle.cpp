 ...
 * is based.
 *下面有很多helper函数，它们是从Fusion样式所使用的各种私有Qt部分复制而来的，而tile样式正是基于Fusion样式。
 ...
 * 根据GNU Lesser General Public License version 2.1的条款使用
 */
...
// The default button and handle gradient默认按钮和手柄梯度
