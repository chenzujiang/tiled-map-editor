...
/**方便的方法 拷贝当前的选择到节切板上。拷贝瓦砖选择或者对象选择
...
/**方便的方法 对象组的粘贴处理一些逻辑的关系
 * Convenience method that deals with some of the logic related to pasting a group of objects.
 */
