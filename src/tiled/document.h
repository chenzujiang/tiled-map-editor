...
/**
 * Returns the undo stack of this document.
 * Should be used to push any commands on that modify the document.
 * 应该使用推动的任何命令来文档修改
 */
...
//用别名声明来定义类型的别名
using DocumentPtr = QSharedPointer<Document>;//Document类型的共享指针
