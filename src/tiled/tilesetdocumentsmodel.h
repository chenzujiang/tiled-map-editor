 ...
 * Copyright 2017, Thorbj酶rn Lindeijer <bjorn@lindeijer.nl>
 *
 ...
 * tileset files, as well as both internal and external tilesets loaded as part of a map.
 *
 *这个模型公开了tileset文档的列表。这包括打开的tileset文件，以及作为地图的
 * 一部分加载的内部和外部的tilesets。
 *它还拥有TilesetDocument实例。
...
/**按字母顺序对tilesets进行分类，并过滤掉不属于当前地图文档的嵌入的tilesets
