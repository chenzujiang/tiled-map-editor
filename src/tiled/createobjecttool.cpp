 ...
 * Copyright 2010-2011, Thorbj酶rn Lindeijer <thorbjorn@lindeijer.nl>
 *
...
void CreateObjectTool::activate/*刺激，激活*/(MapScene *scene)
{
    AbstractObjectTool::activate(scene);
    scene->addItem(mObjectGroupItem);
}

void CreateObjectTool::deactivate(MapScene *scene)/*不活跃,无效的*/
{
