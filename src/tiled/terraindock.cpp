/*
 * terraindock.cpp
 * Copyright 2008-2012, Thorbj酶rn Lindeijer <thorbjorn@lindeijer.nl>
...
TerrainDock::TerrainDock(QWidget *parent)
    ...
    , mInitializing(false)
{
    setObjectName(QLatin1String("TerrainDock"));//地形
    ...
    mAddTerrainType->setCheckable(true);
    ...
    horizontal->addWidget(mToolBar);//mapDoumet不起作用的 tiledDoument起作用
    ...
    connect(mRemoveTerrainType, &QAction::triggered,this, &TerrainDock::removeTerrainTypeRequested);
    connect(mMoveTerrainTypeUp, &QAction::triggered,this, &TerrainDock::moveTerrainTypeUp);
    connect(mMoveTerrainTypeDown, &QAction::triggered,this, &TerrainDock::moveTerrainTypeDown);
